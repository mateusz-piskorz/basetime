...
export const SectionOrgInfo = () => {
    const { orgId } = useMember();

    const { data, isLoading, error } = trpc.organizations.useQuery({ orgId });

    return (
        <div className="space-y-8 px-4 md:px-8">
            <DashboardHeading title="Organization information" description="Update your organizations name and currency" />
