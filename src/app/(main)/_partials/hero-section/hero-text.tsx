    ...
    return (
        <div
            className={cn(
                ...
                'lg:ml-10 lg:min-w-[430px] lg:items-start lg:text-start',
                'xl:min-w-[570px] xl:gap-8',
                '2xl:ml-20 2xl:min-w-[710px]',
            )}
        >
            ...
            <h1
                className={cn(
                    ...
                    'sm:text-4xl',
                    'lg:max-w-[430px] lg:text-4xl',
                    'xl:max-w-[570px] xl:text-5xl',
                    '2xl:max-w-[710px] 2xl:text-6xl',
                )}
            >
                <span className="text-accent">Time tracker</span> - your team will actually use
            </h1>
            <p className="text-muted-foreground text-base lg:max-w-[370px] xl:max-w-[500px] xl:text-lg 2xl:max-w-[640px] 2xl:text-2xl">
