...
export const SectionDeleteOrg = () => {
    ...
    const onSubmit = async ({ password }: z.infer<typeof deleteOrgSchema>) => {
        const res = await deleteOrg({ orgId, password });
    ...
    return (
        <div className="space-y-8 px-4 md:px-8">
            <DashboardHeading title="Delete organization" description="delete organization and all of its resources permanently" />
